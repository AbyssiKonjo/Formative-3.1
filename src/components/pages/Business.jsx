...
const Business = () => {
    ...
    useEffect(() => {
      ...
      const fetchArticles = async () => {
        await axios.get(`https://newsapi.org/v2/top-headlines?category=business&language=en&apiKey=${apiKey}`)
          .then(response => {
    ...
    return (
      <div className='health-page'>
        <header>BUSINESS NEWS</header>
  
        <div className='article-container'>
          {loading ? (
            <div>Loading Business Page Please Wait...</div>
          ) : (
