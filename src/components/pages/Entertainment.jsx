...
const Entertainment = () => {
    ...
    useEffect(() => {
      ...
      const fetchArticles = async () => {
        await axios.get(`https://newsapi.org/v2/top-headlines?category=entertainment&language=en&apiKey=${apiKey}`)
          .then(response => {
    ...
    return (
      <div className='health-page'>
        <header>ENTERTAINMENT NEWS</header>
  
        <div className='article-container'>
          {loading ? (
            <div>Loading Entertainment Page Please Wait...</div>
          ) : (
