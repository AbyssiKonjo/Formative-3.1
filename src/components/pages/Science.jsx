...
const Science = () => {
    ...
    useEffect(() => {
      ...
      const fetchArticles = async () => {
        await axios.get(`https://newsapi.org/v2/top-headlines?category=science&language=en&apiKey=${apiKey}`)
          .then(response => {
    ...
    return (
      <div className='health-page'>
        <header>SCIENCE NEWS</header>
  
        <div className='article-container'>
          {loading ? (
            <div>Loading Science Page Please Wait...</div>
          ) : (
